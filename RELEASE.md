...
Current shipping target: **1.7.0** (`versionCode` **10705**, `versionCodeOffset` **5**).
...
- **Version:** `versionName` / `versionCode` from root [`build.gradle.kts`](build.gradle.kts) (currently **1.7.0** / **10705**)
